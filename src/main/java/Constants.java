public class Constants {
    ...
    public static final String ADDITIONAL_SURCHARGE = "Additional surcharge ";
    ...
    public static final int minimumAge = 16;
    public static final String NOT_INSURABLE_AGE_MESSAGE = "You should be at least " + minimumAge + " years old to insure your vehicle\nBye...";
